...
class TipsControllerTest < ActionController::TestCase
  ...
  test "should create tip" do
    assert_difference('Tip.count') do
      post :create, tip: { description: @tip.description, image_url: @tip.image_url, title: @tip.title }
    end
  ...
  test "should update tip" do
    put :update, id: @tip, tip: { description: @tip.description, image_url: @tip.image_url, title: @tip.title }
    assert_redirected_to tip_path(assigns(:tip))
  end
