...
class TestimonialsControllerTest < ActionController::TestCase
  ...
  test "should create testimonial" do
    assert_difference('Testimonial.count') do
      post :create, testimonial: { description: @testimonial.description, image_url: @testimonial.image_url, title: @testimonial.title }
    end
  ...
  test "should update testimonial" do
    put :update, id: @testimonial, testimonial: { description: @testimonial.description, image_url: @testimonial.image_url, title: @testimonial.title }
    assert_redirected_to testimonial_path(assigns(:testimonial))
  end
