...
class FaqsControllerTest < ActionController::TestCase
  ...
  test "should create faq" do
    assert_difference('Faq.count') do
      post :create, faq: { description: @faq.description, image_url: @faq.image_url, title: @faq.title }
    end
  ...
  test "should update faq" do
    put :update, id: @faq, faq: { description: @faq.description, image_url: @faq.image_url, title: @faq.title }
    assert_redirected_to faq_path(assigns(:faq))
  end
