...
class CalendarsControllerTest < ActionController::TestCase
  ...
  test "should create calendar" do
    assert_difference('Calendar.count') do
      post :create, calendar: { description: @calendar.description, image_url: @calendar.image_url, title: @calendar.title }
    end
  ...
  test "should update calendar" do
    put :update, id: @calendar, calendar: { description: @calendar.description, image_url: @calendar.image_url, title: @calendar.title }
    assert_redirected_to calendar_path(assigns(:calendar))
  end
